      ...
      if ((filter.isNotEmpty)) {
        ...
        for (int i = 0; i < _filteredlist.length; i++) {
          if (_filteredlist[i]
              .name
              .toLowerCase()
              .contains(filter.toLowerCase())) tmpList.add(_filteredlist[i]);
        }
              ...
              child: Column(
                children: [
                  ...
                  (googleMapsAppData.searchResults != null &&
                          ...
                          widget.addtext != "addwaypt" &&
                          widget.addtext != "gymming" &&
                          widget.addtext != "zumba")
                      ? Container(
                          height: 400,
                  ...
                  (apicall != null &&
                      ...
                      ? Container(
                          ...
                          child: ListView.separated(
                            itemCount:
                                apicall == null ? 0 : _filteredlist.length,
                            separatorBuilder: (
                              BuildContext context,
                              int index,
                            ) =>
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                title: Column(children: [
                                  ...
                                  Text(
                                    LatLng(_filteredlist[index].lat,
                                            _filteredlist[index].lng)
                                        .toString(),
                                    overflow: TextOverflow.ellipsis,
                                    style: TextStyle(
                                        fontSize: 12.0, color: Colors.blueGrey),
                                ...
                                onTap: () {
                                  Navigator.pop(context,
                                      "${_filteredlist[index].lat},${_filteredlist[index].lng}");
                                },
                              );
                            },
                            shrinkWrap: true,
                  ...
                  (facilcall != null &&
                      ...
                      ? Container(
                          height: 400,
                          child: ListView.separated(
                            itemCount: facilcall == null
                                ? 0
                                : facilfilteredlist.length,
                            separatorBuilder: (
                              BuildContext context,
                              int index,
                            ) =>
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                ...
                                onTap: () {
                                  Navigator.pop(context,
                                      "${facilfilteredlist[index].lat},${facilfilteredlist[index].lng}");
                                },
                              );
                            },
                            shrinkWrap: true,
    ...
    if (json['status'] == 'OK') {
      ...
      if (widget.addtext == "Start") {
        Provider.of<GoogleMapsAppData>(context, listen: false)
            .updateStartLocationAddress(newplace);
        Navigator.pop(context, "obtainDirection");
      }
      if (widget.addtext == "End") {
        Provider.of<GoogleMapsAppData>(context, listen: false)
            .updateDestLocationAddress(newplace);
        Navigator.pop(context, "obtainDirection");
      }
